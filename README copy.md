This is a fork of Hashlip's art engine. It is currently a *Work in Progress* as more features are planned to be added. Please be sure to read through the docs, as some of the added features change how the engine works. 
